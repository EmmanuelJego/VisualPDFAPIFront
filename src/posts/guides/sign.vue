...
export default defineComponent({
  ...
  mixins: [createMetaMixin(() => ({
    title: 'Visual PDF API guides - How to add a signature to a PDF',
    description: 'Learn with this guide how you can add one or more signatures to a PDF, in the location of your choice. Easy-to-use PDF REST API.',
