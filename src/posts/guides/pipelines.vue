...
export default defineComponent({
  ...
  mixins: [createMetaMixin(() => ({
    title: 'Visual PDF API guides - How to combine PDF tools',
    description: 'In this guide we will discover in detail what a pipeline is in Visual PDF API, all the possibilities that this mechanism offers, with its different options and combinations of tasks.',
