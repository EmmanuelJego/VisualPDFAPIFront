...
export default defineComponent({
  ...
  mixins: [createMetaMixin(() => ({
    title: 'Visual PDF API docs - Downloading files',
    description: 'Download a file generated by a pipeline processing. Only files generated by pipelines completed less than 1 hour ago are available for download.',
